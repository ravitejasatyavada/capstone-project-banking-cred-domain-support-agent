...
from rag.cached_retrieval import coll_sentence, embedder, get_sentence_chunks
from api.middleware import GovernanceShieldMiddleware
...
app.add_middleware(GovernanceShieldMiddleware)
